...
function convertFrom() {
  ...
  if (
    selectValueFrom.innerText == "Tonne" &&
    selectValueTo.innerText == "Pound"
  ) {
    toValue.value = checkIfContainsDecimalAndTruncate(fromValue.value * 2205);
  } else if (
    ...
    toValue.value = checkIfContainsDecimalAndTruncate(fromValue.value * 1e6);
  } else if (
    selectValueFrom.innerText == "Tonne" &&
    selectValueTo.innerText == "Ounce"
  ) {
  ...
  if (
    selectValueFrom.innerText == "Gram" &&
    selectValueTo.innerText == "Pound"
  ) {
    toValue.value = checkIfContainsDecimalAndTruncate(fromValue.value * 454);
  } else if (
  ...
  if (
    selectValueFrom.innerText == "Ounce" &&
    selectValueTo.innerText == "Pound"
  ) {
    toValue.value = checkIfContainsDecimalAndTruncate(fromValue.value / 16);
  } else if (
